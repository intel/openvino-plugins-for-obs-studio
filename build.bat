...
set "BUILD_DIR=%USERPROFILE%\Documents\Intel\OpenVINO\openvino-plugins-for-obs-build"

set SUPPORTED_VS_VERSIONS=VS2015 VS2017 VS2019 VS2022
...
:usage
echo Build OpenVINO OBS Smart Framing Lab Plugin
echo.
echo Options:
